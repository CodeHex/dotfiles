...
# Git settings
export GIT_NAME="<name>"                # e.g. export GIT_NAME="Linda Hogan"
export GIT_EMAIL="<email_address>"      # e.g. export GIT_EMAIL="linda.hogan@gmail.com"
export GIT_USERNAME="<git_username>"    # e.g. export GIT_USERNAME="lindah"
